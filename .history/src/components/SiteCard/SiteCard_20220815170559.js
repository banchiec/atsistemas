...
const SiteCard = (site) => {
    const { _id, description, name, path, publicPath } = site.site
          ...
          <div className="ui link cards">
            <div className="card">
              ...
              <div className="content">
                ...
                <div className="meta description">Descripcion: {description}</div>
                <div className="meta"> Path: {path}</div>
                <div className="meta">PublicPath: {publicPath}</div>
